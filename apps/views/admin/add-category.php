...
<head>
    ...
    <title>Quiz Sun - Add Category</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center>
                    ...
                    <h1 class="brand-name">Quiz Sun Add Category</h1>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <form action="<?php $baseUrl; ?>index.php?page=auth&action=proses-category.php" method="post" name="loginAdmin" id="contactForm" novalidate>
