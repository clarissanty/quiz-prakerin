    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center>
                    ...
                    <h1 class="brand-name">Quiz Sun Category</h1>
        ...
        <div class="row">
            <div class="box">
                ...
                <div>
                    ...
                    <a href="<?php $baseUrl; ?>index.php?page=auth&action=add-category" class="btn btn-default">Add Category</a>
